...
public class Organization extends TableImpl<OrganizationRecord> {
     ...
     */
    public final TableField<OrganizationRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(64).nullable(false), this, "");
    ...
    public List<UniqueKey<OrganizationRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ORGANIZATION_NAME_KEY);
    }
